...
|---------|-----------|--------|------|--------|
| 市場データ | BIツール市場、データ分析SaaS、ノーコード分析 | 調査レポート | 月1回 | data/collected/market/ |
| 競合情報 | Tableau, Power BI, Looker, Metabase, Mode Analytics | 競合サイト | 週1回 | data/collected/competitor/ |
| 技術動向 | Pandas, LLM Data Analysis, Natural Language Query | GitHub、公式ドキュメント | 週1回 | data/collected/tech/ |
| SNSトレンド | #データ分析 #BI #ノーコード分析 #AIデータ分析 | X/Twitter | 日1回 | data/collected/social/ |
| 法規制 | 個人情報保護法、データプライバシー規制 | 官公庁サイト | 月1回 | data/collected/legal/ |
...
|-----------------|-----------|------|------|
| X/Twitter | @InsightAnalyzerAI | データ分析Tips・インサイト共有 | 要開設 |

### 投稿スケジュール
| 曜日 | 時間 | コンテンツタイプ |
|------|------|-----------------|
| 月-金 | 09:00, 18:00 | 価値提供投稿（データ分析手法、可視化Tips） |
| 土日 | 12:00 | 週間まとめ |
